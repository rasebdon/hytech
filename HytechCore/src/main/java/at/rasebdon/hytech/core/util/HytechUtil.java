...
public class HytechUtil {
    ...
    // getRotationIndex is deprecated *for removal* and has no replacement: 0.6.0 removed
    // BlockAccessor.getRotation outright, so there is nothing else that answers this. Suppressed
    // rather than worked around, and it will have to be revisited when the method actually goes.
