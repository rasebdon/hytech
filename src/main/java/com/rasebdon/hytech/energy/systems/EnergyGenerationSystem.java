...
public class EnergyGenerationSystem extends EntityTickingSystem<ChunkStore> {
    ...
    private final ComponentType<ChunkStore, BlockEnergyContainerComponent> containerType;
    ...
    public EnergyGenerationSystem(
            ...
            ComponentType<ChunkStore, BlockEnergyContainerComponent> containerType) {
